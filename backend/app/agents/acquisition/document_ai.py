...
# Simple config
class settings:
    PDF_STORAGE_PATH = os.getenv("PDF_STORAGE_PATH", "/tmp/procureflow/pdfs")
...
class DocumentAIAgent(BaseAgent):
    ...
    async def execute(self, context: Dict[str, Any]) -> AgentResult:
        ...
        output = {
            ...
            "source": "pdf_parsing" if pdf_texts else ("demo_data" if settings.DEMO_MODE else "unavailable"),
        }
        ...
        for p in patterns:
            ...
            if m:
                try:
                    ...
                    continue
        return 500_000 if settings.DEMO_MODE else 0.0
    ...
    def _extract_completion_days(self, text: str) -> int:
        ...
        return 540 if settings.DEMO_MODE else 0
    ...
    def _extract_experience(self, text: str) -> int:
        ...
        if m:
            return int(m.group(1))
        return 5 if settings.DEMO_MODE else 0
    ...
    def _extract_turnover(self, text: str) -> float:
        ...
        if m:
            try:
                ...
                pass
        return 50_000_000 if settings.DEMO_MODE else 0.0
